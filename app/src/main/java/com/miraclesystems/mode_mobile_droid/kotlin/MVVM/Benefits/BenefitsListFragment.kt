...
import com.miraclesystems.mode_mobile_droid.kotlin.MVVM.Guides.GuidesDetailFragment
 ...
 * Use the [BenefitsListFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BenefitsListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view : View =  inflater.inflate(R.layout.fragment_benefits_list, container, false)

        var benefitsActivity = activity as BenefitsActivity

        var adapter = BenefitsListAdapter(benefitsActivity.applicationContext, benefitsActivity.viewModel.getAllBenefits())
    ...
    companion object {
         ...
         * @return A new instance of fragment BenefitsListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BenefitsListFragment()
                .apply {
